"""
Django settings for SisSuper project.
...
SECRET_KEY = 'django-insecure-%!(2p=-b##bhqc$q^3yzjy-$!uk!9%oj0a5yekpaza9q99$0r7'
...
WSGI_APPLICATION = 'SisSuper.wsgi.application'
